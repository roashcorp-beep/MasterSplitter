...
(function (global) {
    ...
    const dictionary = {
        he: {
            ...
            currencySearchPh: 'חיפוש מטבע...',
            twoFaOff: 'כבוי',
            twoFaEmail: 'אימייל',
            twoFaFingerprint: 'טביעת אצבע / WebAuthn',
            twoFaOffDesc: 'ללא אימות נוסף',
            twoFaEmailDesc: 'קוד אימות לאימייל',
            twoFaFingerprintDesc: 'אימות ביומטרי',
            videoComingSoon: 'הסרטון יתווסף בקרוב',
            ...
            permissionsTitle: 'ברוכים הבאים! נשמח לכמה הרשאות:',
            permissionsContactsTitle: 'אנשי קשר',
            permissionsContactsDesc: 'להזמנת חברים בקלות.',
            permissionsDisplayTitle: 'תצוגה',
            permissionsDisplayDesc: 'להתאמת מצב כהה/בהיר.',
            permissionsConfirmBtn: 'אשר והמשך',
        ...
        en: {
            ...
            currencySearchPh: 'Search currency...',
            twoFaOff: 'Off',
            twoFaEmail: 'Email',
            twoFaFingerprint: 'Fingerprint / WebAuthn',
            twoFaOffDesc: 'No additional verification',
            twoFaEmailDesc: 'Verification code via email',
            twoFaFingerprintDesc: 'Biometric authentication',
            ...
            permissionsDisplayDesc: 'To match dark/light mode.',
            permissionsConfirmBtn: 'Allow & Continue',
        ...
        es: {
            ...
            currencySearchPh: 'Buscar moneda...',
            twoFaOff: 'Desactivado',
            twoFaEmail: 'Correo electrónico',
            twoFaFingerprint: 'Huella digital / WebAuthn',
            twoFaOffDesc: 'Sin verificación adicional',
            twoFaEmailDesc: 'Código de verificación por correo',
            twoFaFingerprintDesc: 'Autenticación biométrica',
            ...
            permissionsTitle: '¡Bienvenido/a! Nos gustaría pedirte algunos permisos:',
            permissionsContactsTitle: 'Contactos',
            permissionsContactsDesc: 'Para invitar amigos fácilmente.',
            permissionsDisplayTitle: 'Pantalla',
            permissionsDisplayDesc: 'Para ajustar el modo oscuro/claro.',
            permissionsConfirmBtn: 'Permitir y continuar',
        ...
        ru: {
            ...
            currencySearchPh: 'Поиск валюты...',
            twoFaOff: 'Выкл.',
            twoFaEmail: 'Email',
            twoFaFingerprint: 'Отпечаток пальца / WebAuthn',
            twoFaOffDesc: 'Без дополнительной проверки',
            twoFaEmailDesc: 'Код подтверждения по email',
            twoFaFingerprintDesc: 'Биометрическая аутентификация',
            ...
            permissionsTitle: 'Добро пожаловать! Нам нужно несколько разрешений:',
            permissionsContactsTitle: 'Контакты',
            permissionsContactsDesc: 'Чтобы легко приглашать друзей.',
            permissionsDisplayTitle: 'Отображение',
            permissionsDisplayDesc: 'Для настройки тёмного/светлого режима.',
            permissionsConfirmBtn: 'Разрешить и продолжить',
        ...
        ar: {
            ...
            currencySearchPh: 'بحث عن عملة...',
            twoFaOff: 'إيقاف',
            twoFaEmail: 'البريد الإلكتروني',
            twoFaFingerprint: 'بصمة الإصبع / WebAuthn',
            twoFaOffDesc: 'بدون تحقق إضافي',
            twoFaEmailDesc: 'رمز تحقق عبر البريد الإلكتروني',
            twoFaFingerprintDesc: 'مصادقة بيومترية',
            videoComingSoon: 'الفيديو سيتوفر قريباً',
            ...
            permissionsTitle: 'مرحبًا بك! نحتاج إلى بعض الأذونات:',
            permissionsContactsTitle: 'جهات الاتصال',
            permissionsContactsDesc: 'لدعوة الأصدقاء بسهولة.',
            permissionsDisplayTitle: 'العرض',
            permissionsDisplayDesc: 'لمطابقة الوضع الداكن/الفاتح.',
            permissionsConfirmBtn: 'السماح والمتابعة',
        ...
        fr: {
            ...
            currencySearchPh: 'Rechercher une devise...',
            twoFaOff: 'Désactivé',
            twoFaEmail: 'E-mail',
            twoFaFingerprint: 'Empreinte digitale / WebAuthn',
            twoFaOffDesc: 'Aucune vérification supplémentaire',
            twoFaEmailDesc: 'Code de vérification par e-mail',
            twoFaFingerprintDesc: 'Authentification biométrique',
            ...
            permissionsTitle: 'Bienvenue ! Nous aimerions quelques autorisations :',
            permissionsContactsTitle: 'Contacts',
            permissionsContactsDesc: 'Pour inviter facilement des amis.',
            permissionsDisplayTitle: 'Affichage',
            permissionsDisplayDesc: 'Pour adapter le mode sombre/clair.',
            permissionsConfirmBtn: 'Autoriser et continuer',
        ...
        zh: {
            ...
            currencySearchPh: '搜索货币...',
            twoFaOff: '关闭',
            twoFaEmail: '电子邮件',
            twoFaFingerprint: '指纹 / WebAuthn',
            twoFaOffDesc: '无需额外验证',
            twoFaEmailDesc: '通过电子邮件验证码',
            twoFaFingerprintDesc: '生物识别认证',
            ...
            permissionsTitle: '欢迎！我们需要一些权限：',
            permissionsContactsTitle: '通讯录',
            permissionsContactsDesc: '以便轻松邀请好友。',
            permissionsDisplayTitle: '显示',
            permissionsDisplayDesc: '以匹配深色/浅色模式。',
            permissionsConfirmBtn: '允许并继续',
